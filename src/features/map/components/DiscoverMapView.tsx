            ...
            >
              ...
              >
                <MaterialCommunityIcons
                  name={
                    (CATEGORY_ICONS[task.category] as any) ?? "help-circle-outline"
                  }
                  size={16}
                  color="#fff"
                />
      ...
      {selectedTask && (
        <View style={[s.previewWrap, { bottom: TAB_BAR_HEIGHT + 12 }]}>
          <View style={s.previewCard}>
            ...
            <View style={s.previewRow}>
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      CATEGORY_COLORS[selectedTask.category] ??
              ...
              >
                <MaterialCommunityIcons
                  name={
                    (CATEGORY_ICONS[selectedTask.category] as any) ??
                    "help-circle-outline"
                  }
                  size={18}
                  color="#fff"
            ...
            <Pressable
              onPress={() => onTaskPress(selectedTask.id)}
              style={s.previewBtn}
            >
